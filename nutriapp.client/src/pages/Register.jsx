          ...
          <input
            ...
            {...register("password", {
              ...
              validate: {
                hasLower: (value) =>
                  /[a-z]/.test(value) ||
                  "Twoje hasło musi posiadać minimum jedną mała literę (a-z)",
                hasUpper: (value) =>
                  /[A-Z]/.test(value) ||
                  "Twoje hasło musi posiadać minimum jedną wielką literę (A-Z)",
                hasNumber: (value) =>
                  /[0-9]/.test(value) || "Twoje hasło musi zawierać cyfrę",
